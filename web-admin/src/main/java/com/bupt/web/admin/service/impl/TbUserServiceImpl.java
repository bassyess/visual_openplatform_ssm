package com.bupt.web.admin.service.impl;

import com.bupt.commons.dto.BaseResult;
import com.bupt.commons.dto.PageInfo;
import com.bupt.commons.validator.BeanValidator;
import com.bupt.domain.TbUser;
import com.bupt.web.admin.dao.TbUserDao;
...
public class TbUserServiceImpl implements TbUserService {
    ...
    public TbUser login(String email, String password) {
        ...
        if(tbUser != null){
            ...
            //判断加密后的密码和数据库存放的密码是否匹配，匹配则表示允许登录
